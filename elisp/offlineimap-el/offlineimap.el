...
(defcustom offlineimap-mode-line-mod "OfflineIMAP "
  "String used to prepend OfflineIMAP status in mode-line."
  :group 'offlineimap
  :type 'string)
...
(defface offlineimap-msg-default-face
  '((t (:height 2.0)))
  "Default offlineimap face for acct lines."
  :group 'offlineimap)
...
(defun offlineimap-update-mode-line (process)
  ...
  (setq offlineimap-mode-line-string
        (propertize
         (concat " [" offlineimap-mode-line-mod
