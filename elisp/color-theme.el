...
;;      (mouse-color . "white")
     ...
     (font-lock-preprocessor-face ((t (:bold t :foreground "orangered"))))
     (font-lock-reference-face ((t (:bold t :foreground "red"))))
     (font-lock-string-face ((t (:bold t  :foreground "plum"))))
